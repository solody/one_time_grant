...
namespace Drupal\one_time_grant\Plugin\Oauth2Grant;

use Drupal\one_time_grant\Grant\OneTimeGrant;
 ...
 * @Oauth2Grant(
 *   id = "one_time",
 *   label = @Translation("One Time")
 * )
 */
class OneTime extends Oauth2GrantBase {
  ...
  public function getGrantType() {
    $grant = new OneTimeGrant($this->userRepository, $this->refreshTokenRepository);
